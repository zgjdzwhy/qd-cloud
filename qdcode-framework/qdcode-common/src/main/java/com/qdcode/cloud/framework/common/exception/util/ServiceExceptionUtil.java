package com.qdcode.cloud.framework.common.exception.util;
 ...
 *
 * 1. 异常提示信息，写在枚举类中，例如说，cn.iqdcode.oceans.user.api.constants.ErrorCodeEnum 类 + ServiceExceptionConfiguration
