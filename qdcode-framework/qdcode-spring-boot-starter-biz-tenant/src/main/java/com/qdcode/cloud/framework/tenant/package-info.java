 ...
 *      1）Spring Async：
 *          {@link com.qdcode.cloud.framework.quartz.config.QdcodeAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 QdcodeSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.qdcode.cloud.framework.tenant;
