package com.qdcode.cloud.module.member.controller.admin.level.vo.level;

import com.qdcode.cloud.framework.common.enums.CommonStatusEnum;
import com.qdcode.cloud.framework.common.validation.InEnum;
...
public class MemberLevelBaseVO {
    ...
    @Schema(description = "等级名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "巧搭")
    ...
    @Schema(description = "等级图标", example = "https://www.iqdcode.cn/qdcode.jpg")
    @URL(message = "等级图标必须是 URL 格式")
    private String icon;

    @Schema(description = "等级背景图", example = "https://www.iqdcode.cn/qdcode.jpg")
