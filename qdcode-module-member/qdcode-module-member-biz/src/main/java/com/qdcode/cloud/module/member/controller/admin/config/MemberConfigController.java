package com.qdcode.cloud.module.member.controller.admin.config;

import com.qdcode.cloud.framework.common.pojo.CommonResult;
import com.qdcode.cloud.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.qdcode.cloud.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.qdcode.cloud.module.member.convert.config.MemberConfigConvert;
import com.qdcode.cloud.module.member.dal.dataobject.config.MemberConfigDO;
import com.qdcode.cloud.module.member.service.config.MemberConfigService;
