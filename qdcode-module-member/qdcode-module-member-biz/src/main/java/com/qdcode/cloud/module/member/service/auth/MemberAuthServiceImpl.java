package com.qdcode.cloud.module.member.service.auth;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjectUtil;
import com.qdcode.cloud.framework.common.enums.CommonStatusEnum;
import com.qdcode.cloud.framework.common.enums.TerminalEnum;
...
import com.qdcode.cloud.module.member.convert.auth.AuthConvert;
...
import com.qdcode.cloud.module.system.api.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
...
import static com.qdcode.cloud.framework.web.core.util.WebFrameworkUtils.getTerminal;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO 巧搭：后续 member user 手机非强绑定，这块需要做下调整；
