...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.qdcode.cloud";
    private static final String ARTIFACT_ID = "qdcode";
    private static final String PACKAGE_NAME = "com.qdcode.cloud";
    private static final String TITLE = "低代码管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.qdcode.cloud";
        String artifactIdNew = "qdcode";
        String packageNameNew = "com.qdcode.cloud";
        String titleNew = "低代码管理系统";
        String projectBaseDirNew = "D:/git/qdcode/" + "cloud"; // 一键改名后，“新”项目所在的目录
