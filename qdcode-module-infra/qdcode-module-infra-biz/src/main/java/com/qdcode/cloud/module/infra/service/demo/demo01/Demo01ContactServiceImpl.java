package com.qdcode.cloud.module.infra.service.demo.demo01;

import com.qdcode.cloud.framework.common.pojo.PageResult;
import com.qdcode.cloud.framework.common.util.object.BeanUtils;
import com.qdcode.cloud.module.infra.controller.admin.demo.demo01.vo.Demo01ContactPageReqVO;
import com.qdcode.cloud.module.infra.controller.admin.demo.demo01.vo.Demo01ContactSaveReqVO;
import com.qdcode.cloud.module.infra.dal.dataobject.demo.demo01.Demo01ContactDO;
import com.qdcode.cloud.module.infra.dal.mysql.demo.demo01.Demo01ContactMapper;
...
import static com.qdcode.cloud.module.infra.enums.ErrorCodeConstants.DEMO01_CONTACT_NOT_EXISTS;
