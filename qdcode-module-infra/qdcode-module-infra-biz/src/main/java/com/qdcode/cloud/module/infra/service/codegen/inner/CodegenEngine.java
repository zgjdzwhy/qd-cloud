package com.qdcode.cloud.module.infra.service.codegen.inner;
...
import com.qdcode.cloud.framework.excel.core.annotations.DictFormat;
import com.qdcode.cloud.framework.excel.core.convert.DictConvert;
...
import com.qdcode.cloud.framework.operatelog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "qdcode-module-${table.moduleName}/" + // 顶级模块
                "qdcode-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "qdcode-module-${table.moduleName}/" + // 顶级模块
                "qdcode-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "qdcode-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "qdcode-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
