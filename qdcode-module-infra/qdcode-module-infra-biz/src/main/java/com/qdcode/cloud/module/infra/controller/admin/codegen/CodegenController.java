package com.qdcode.cloud.module.infra.controller.admin.codegen;
...
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.qdcode.cloud.module.infra.convert.codegen.CodegenConvert;
...
import com.qdcode.cloud.module.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "qdcode"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "巧搭")
    })
