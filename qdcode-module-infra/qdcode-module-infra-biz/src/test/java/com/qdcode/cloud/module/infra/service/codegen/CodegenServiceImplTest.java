package com.qdcode.cloud.module.infra.service.codegen;
...
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.qdcode.cloud.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.qdcode.cloud.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.qdcode.cloud.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.qdcode.cloud.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.qdcode.cloud.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.qdcode.cloud.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.qdcode.cloud.module.infra.enums.codegen.CodegenSceneEnum;
import com.qdcode.cloud.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.qdcode.cloud.module.infra.framework.codegen.config.CodegenProperties;
import com.qdcode.cloud.module.infra.service.codegen.inner.CodegenBuilder;
import com.qdcode.cloud.module.infra.service.codegen.inner.CodegenEngine;
import com.qdcode.cloud.module.infra.service.db.DatabaseTableService;
import com.qdcode.cloud.module.system.api.user.AdminUserApi;
import com.qdcode.cloud.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.qdcode.cloud.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        when(tableInfo.getComment()).thenReturn("巧搭");
    ...
    @Test
    @Disabled // TODO @巧搭：这个单测会随机性失败，需要定位下；
    ...
    public void testGetDatabaseTableList() {
        ...
        assertEquals("巧搭", result.get(0).getComment());
    }
