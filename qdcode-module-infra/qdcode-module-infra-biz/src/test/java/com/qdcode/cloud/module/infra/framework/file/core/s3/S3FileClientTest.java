package com.qdcode.cloud.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testAliyun() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://ali-oss.iqdcode.cn
        // 默认北京的 endpoint
    ...
    public void testQCloud() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://tengxun-oss.iqdcode.cn
        // 默认上海的 endpoint
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("qd-cloud");
        config.setDomain("http://test.qdcode.iqdcode.cn"); // 如果有自定义域名，则可以设置。http://static.qdcode.iqdcode.cn
        // 默认上海的 endpoint
