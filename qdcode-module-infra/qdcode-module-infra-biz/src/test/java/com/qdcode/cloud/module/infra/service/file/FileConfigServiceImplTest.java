package com.qdcode.cloud.module.infra.service.file;
...
import com.qdcode.cloud.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import com.qdcode.cloud.module.infra.dal.mysql.file.FileConfigMapper;
import com.qdcode.cloud.module.infra.framework.file.core.client.FileClient;
import com.qdcode.cloud.module.infra.framework.file.core.client.FileClientConfig;
import com.qdcode.cloud.module.infra.framework.file.core.client.FileClientFactory;
import com.qdcode.cloud.module.infra.framework.file.core.client.local.LocalFileClient;
import com.qdcode.cloud.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.qdcode.cloud.module.infra.framework.file.core.enums.FileStorageEnum;
import lombok.Data;
...
import static com.qdcode.cloud.framework.test.core.util.RandomUtils.randomLongId;
import static com.qdcode.cloud.framework.test.core.util.RandomUtils.randomPojo;
import static com.qdcode.cloud.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.qdcode.cloud.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai")
                .put("domain", "https://www.iqdcode.cn").build();
        ...
        assertEquals("https://www.iqdcode.cn", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://www.iqdcode.cn")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai2")
                    .put("domain", "https://doc.iqdcode.cn").build();
            o.setConfig(config);
        });
        ...
        assertEquals("https://doc.iqdcode.cn", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("盘古巧搭")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.iqdcode.cn");

        // 调用，并断言
        assertEquals("https://www.iqdcode.cn", fileConfigService.testFileConfig(id));
    }
