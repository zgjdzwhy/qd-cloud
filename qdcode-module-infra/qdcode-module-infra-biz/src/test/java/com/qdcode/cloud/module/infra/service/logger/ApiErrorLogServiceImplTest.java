...
import com.qdcode.cloud.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.qdcode.cloud.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.qdcode.cloud.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.qdcode.cloud.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.qdcode.cloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.qdcode.cloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("qdcode-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("qdcode-test");
