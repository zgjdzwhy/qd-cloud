package com.qdcode.cloud.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.qdcode.cloud.framework.common.pojo.PageResult;
import com.qdcode.cloud.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.qdcode.cloud.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.qdcode.cloud.module.mp.convert.message.MpMessageConvert;
import com.qdcode.cloud.module.mp.dal.dataobject.account.MpAccountDO;
import com.qdcode.cloud.module.mp.dal.dataobject.message.MpMessageDO;
import com.qdcode.cloud.module.mp.dal.dataobject.user.MpUserDO;
import com.qdcode.cloud.module.mp.dal.mysql.message.MpMessageMapper;
import com.qdcode.cloud.module.mp.enums.message.MpMessageSendFromEnum;
import com.qdcode.cloud.module.mp.framework.mp.core.MpServiceFactory;
import com.qdcode.cloud.module.mp.framework.mp.core.util.MpUtils;
import com.qdcode.cloud.module.mp.service.account.MpAccountService;
import com.qdcode.cloud.module.mp.service.material.MpMaterialService;
import com.qdcode.cloud.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.qdcode.cloud.module.mp.service.user.MpUserService;
...
import static com.qdcode.cloud.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
