package com.qdcode.cloud.module.pay.service.wallet;
...
import com.qdcode.cloud.module.pay.dal.dataobject.wallet.PayWalletDO;
...
import com.qdcode.cloud.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import static com.qdcode.cloud.framework.common.util.date.LocalDateTimeUtils.addTime;
import static com.qdcode.cloud.framework.common.util.json.JsonUtils.toJsonString;
import static com.qdcode.cloud.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static com.qdcode.cloud.module.pay.enums.ErrorCodeConstants.*;
import static com.qdcode.cloud.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @巧搭：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
