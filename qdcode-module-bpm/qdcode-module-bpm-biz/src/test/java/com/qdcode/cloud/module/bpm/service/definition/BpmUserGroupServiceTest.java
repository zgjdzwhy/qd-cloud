...
import com.qdcode.cloud.framework.test.core.util.AssertUtils;
...
import com.qdcode.cloud.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
...
import com.qdcode.cloud.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.qdcode.cloud.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("巧搭")));
       // 测试 status 不匹配
