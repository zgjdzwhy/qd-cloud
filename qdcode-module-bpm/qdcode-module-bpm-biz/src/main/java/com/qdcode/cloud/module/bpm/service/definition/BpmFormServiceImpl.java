...
import com.qdcode.cloud.module.bpm.controller.admin.definition.vo.form.BpmFormPageReqVO;
import com.qdcode.cloud.module.bpm.controller.admin.definition.vo.form.BpmFormUpdateReqVO;
import com.qdcode.cloud.module.bpm.convert.definition.BpmFormConvert;
import com.qdcode.cloud.module.bpm.dal.dataobject.definition.BpmFormDO;
import com.qdcode.cloud.module.bpm.dal.mysql.definition.BpmFormMapper;
import com.qdcode.cloud.module.bpm.enums.ErrorCodeConstants;
import com.qdcode.cloud.module.bpm.enums.definition.BpmModelFormTypeEnum;
import com.qdcode.cloud.module.bpm.service.definition.dto.BpmFormFieldRespDTO;
import com.qdcode.cloud.module.bpm.service.definition.dto.BpmModelMetaInfoRespDTO;
...
import static com.qdcode.cloud.module.bpm.enums.ErrorCodeConstants.FORM_NOT_EXISTS;
import static com.qdcode.cloud.module.bpm.enums.ErrorCodeConstants.MODEL_DEPLOY_FAIL_FORM_NOT_CONFIG;
...
public class BpmFormServiceImpl implements BpmFormService {
    ...
    private void checkFields(List<String> fields) {
        if (true) { // TODO 巧搭：兼容 Vue3 工作流：因为采用了新的表单设计器，所以暂时不校验
            return;
        }
