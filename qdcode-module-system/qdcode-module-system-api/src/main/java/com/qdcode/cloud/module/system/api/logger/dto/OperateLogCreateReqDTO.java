package com.qdcode.cloud.module.system.api.logger.dto;
...
public class OperateLogCreateReqDTO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.qdcode.cloud.UserController.save(...)")
