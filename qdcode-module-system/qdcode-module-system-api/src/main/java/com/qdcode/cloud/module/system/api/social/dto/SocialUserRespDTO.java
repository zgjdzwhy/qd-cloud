package com.qdcode.cloud.module.system.api.social.dto;
...
public class SocialUserRespDTO {
    ...
    @Schema(description = "社交用户的头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iqdcode.cn/1.jpg")
