...
import com.qdcode.cloud.framework.common.util.http.HttpUtils;
import com.qdcode.cloud.framework.common.util.json.JsonUtils;
...
import com.qdcode.cloud.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.qdcode.cloud.module.system.util.oauth2.OAuth2Utils;
...
import static com.qdcode.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.qdcode.cloud.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.iqdcode.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.iqdcode.cn"),
