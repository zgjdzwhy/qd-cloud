package com.qdcode.cloud.module.system.service.tenant;

import com.qdcode.cloud.framework.common.enums.CommonStatusEnum;
import com.qdcode.cloud.framework.common.pojo.PageResult;
import com.qdcode.cloud.framework.tenant.config.TenantProperties;
import com.qdcode.cloud.framework.tenant.core.context.TenantContextHolder;
import com.qdcode.cloud.framework.test.core.ut.BaseDbUnitTest;
import com.qdcode.cloud.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.qdcode.cloud.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.qdcode.cloud.module.system.dal.dataobject.permission.MenuDO;
import com.qdcode.cloud.module.system.dal.dataobject.permission.RoleDO;
import com.qdcode.cloud.module.system.dal.dataobject.tenant.TenantDO;
import com.qdcode.cloud.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.qdcode.cloud.module.system.dal.mysql.tenant.TenantMapper;
import com.qdcode.cloud.module.system.enums.permission.RoleCodeEnum;
import com.qdcode.cloud.module.system.enums.permission.RoleTypeEnum;
import com.qdcode.cloud.module.system.service.permission.MenuService;
import com.qdcode.cloud.module.system.service.permission.PermissionService;
import com.qdcode.cloud.module.system.service.permission.RoleService;
import com.qdcode.cloud.module.system.service.tenant.handler.TenantInfoHandler;
import com.qdcode.cloud.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.qdcode.cloud.framework.common.util.collection.SetUtils.asSet;
import static com.qdcode.cloud.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.qdcode.cloud.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.qdcode.cloud.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.qdcode.cloud.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.qdcode.cloud.framework.test.core.util.AssertUtils.assertServiceException;
import static com.qdcode.cloud.framework.test.core.util.RandomUtils.*;
import static com.qdcode.cloud.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static com.qdcode.cloud.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("巧搭", user.getNickname());
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsite("https://www.iqdcode.cn");
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("巧搭"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("巧搭");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsite("https://www.iqdcode.cn"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.iqdcode.cn");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
