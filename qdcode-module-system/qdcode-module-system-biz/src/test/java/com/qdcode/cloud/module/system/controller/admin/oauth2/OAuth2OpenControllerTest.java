package com.qdcode.cloud.module.system.controller.admin.oauth2;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.qdcode.cloud.framework.common.core.KeyValue;
import com.qdcode.cloud.framework.common.enums.UserTypeEnum;
import com.qdcode.cloud.framework.common.exception.ErrorCode;
...
import com.qdcode.cloud.framework.common.util.object.ObjectUtils;
import com.qdcode.cloud.framework.test.core.ut.BaseMockitoUnitTest;
import com.qdcode.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.qdcode.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.qdcode.cloud.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.qdcode.cloud.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.qdcode.cloud.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.qdcode.cloud.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.qdcode.cloud.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.qdcode.cloud.module.system.service.oauth2.OAuth2ApproveService;
import com.qdcode.cloud.module.system.service.oauth2.OAuth2ClientService;
import com.qdcode.cloud.module.system.service.oauth2.OAuth2GrantService;
import com.qdcode.cloud.module.system.service.oauth2.OAuth2TokenService;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://www.iqdcode.cn";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.iqdcode.cn#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://www.iqdcode.cn#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://www.iqdcode.cn#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.iqdcode.cn?code=test_code&state=test", result.getData());
    }
