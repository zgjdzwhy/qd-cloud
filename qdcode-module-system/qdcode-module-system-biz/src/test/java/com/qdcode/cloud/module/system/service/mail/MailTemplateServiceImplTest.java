package com.qdcode.cloud.module.system.service.mail;
...
import com.qdcode.cloud.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.qdcode.cloud.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.qdcode.cloud.module.system.dal.dataobject.mail.MailTemplateDO;
import com.qdcode.cloud.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.qdcode.cloud.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("巧搭")));
        // 测试 code 不匹配
