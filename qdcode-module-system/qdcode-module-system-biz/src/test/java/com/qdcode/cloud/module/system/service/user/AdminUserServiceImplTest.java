package com.qdcode.cloud.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.qdcode.cloud.framework.common.enums.CommonStatusEnum;
import com.qdcode.cloud.framework.common.exception.ServiceException;
import com.qdcode.cloud.framework.common.pojo.PageResult;
import com.qdcode.cloud.framework.common.util.collection.ArrayUtils;
import com.qdcode.cloud.framework.common.util.collection.CollectionUtils;
import com.qdcode.cloud.framework.test.core.ut.BaseDbUnitTest;
import com.qdcode.cloud.module.infra.api.file.FileApi;
import com.qdcode.cloud.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.qdcode.cloud.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.qdcode.cloud.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.qdcode.cloud.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.qdcode.cloud.module.system.controller.admin.user.vo.user.UserPageReqVO;
...
import com.qdcode.cloud.module.system.dal.dataobject.dept.UserPostDO;
...
import com.qdcode.cloud.module.system.dal.mysql.dept.UserPostMapper;
import com.qdcode.cloud.module.system.dal.mysql.user.AdminUserMapper;
import com.qdcode.cloud.module.system.enums.common.SexEnum;
import com.qdcode.cloud.module.system.service.dept.DeptService;
...
import com.qdcode.cloud.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("qdcodeyuanma");
        ...
        assertEquals("qdcodeyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("qdcodeyuanma"))).thenReturn("java");
