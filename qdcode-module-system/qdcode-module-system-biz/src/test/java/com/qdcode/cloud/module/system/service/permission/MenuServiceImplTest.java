package com.qdcode.cloud.module.system.service.permission;
...
import com.qdcode.cloud.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.qdcode.cloud.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.qdcode.cloud.module.system.dal.dataobject.permission.MenuDO;
import com.qdcode.cloud.module.system.dal.mysql.permission.MenuMapper;
import com.qdcode.cloud.module.system.enums.permission.MenuTypeEnum;
...
import static com.qdcode.cloud.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("巧搭").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
